...
from stackerlberg.trainers.utils import randomise_leader_policy_each_episode, randomize_weights_cnn
...
def stackerlberg_trainable(config):
    ...
    try:
        ...
        for pre_training_iteration in range(config.get("pre_training_iterations", 0)):
            ...
            if pre_training_iteration % 1 == 0:
                new_weights = randomize_weights_cnn(leader_trainer.get_weights(leader_agent_id), leader_agent_id)
